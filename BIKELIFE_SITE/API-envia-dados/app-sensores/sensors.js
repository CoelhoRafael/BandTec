function lm393(min, max) {
    min = typeof min == 'undefined' ? 1 : min;
    max = typeof max == 'undefined' ? 120 : max;
...
function dht11(options){
    ...
    if (minTemperature < 0 || maxTemperature > 50) {
        throw new Error('Os valores minímos e máximos para velocidade são 0 e 50 respectivamente.')
    }

    minTemperature = typeof minTemperature == 'undefined' ? 1 : minTemperature;
    maxTemperature = typeof maxTemperature == 'undefined' ? 40 : maxTemperature;
...
module.exports = {lm393, trc5000, ldr, dht11};
